...
const AddSize = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post("http://localhost:3000/api/sizes", {
                name,
                description
            });

            if (response.status === 200 || response.status === 201) {
                toast.success("Size đã được thêm thành công!", {
                    position: "top-right",
                    autoClose: 2000,
            ...
            toast.error("Đã xảy ra lỗi khi thêm size.");
        }
    };
        ...
        <div className="pd-ltr-20 xs-pd-20-10">
            <div className="min-height-200px">
                ...
                <div className="pd-20 card-box mb-30">
                    <h4 className="text-blue h4 mb-20">Form Thêm Size</h4>
